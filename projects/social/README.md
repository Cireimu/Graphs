...
1. To create 100 users with an average of 10 friends each, how many times would you need to call `add_friendship()`? Why?
   You would most likely need to call it at least 4950 times, this is due to how many friendship pairs there would be and adding friends is done a pair at a time
