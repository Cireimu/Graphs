...
1. To create 100 users with an average of 10 friends each, how many times would you need to call `add_friendship()`? Why?
   You would most likely need to call it at least 500 times, this is because of how I'm adding them as pairs, and initialy creating pairs going within the range of users
